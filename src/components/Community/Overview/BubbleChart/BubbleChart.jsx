...
const BubbleChart = () => {
  ...
  // data for the bubble chart, all of this should be an array getting looped over once end-point at api is changed.
  ...
  let one_mentions = Number(
    populated_tickers.data[0].mentions.toFixed(2) / 100
  );
  ...
  let two_mentions = Number(
    populated_tickers.data[1].mentions.toFixed(2) / 100
  );
  ...
  let three_mentions = Number(
    populated_tickers.data[2].mentions.toFixed(2) / 100
  );
  ...
  let four_mentions = Number(
    populated_tickers.data[3].mentions.toFixed(2) / 100
  );
  ...
  let five_mentions = Number(
    populated_tickers.data[4].mentions.toFixed(2) / 100
  );
  ...
  let six_mentions = Number(
    populated_tickers.data[5].mentions.toFixed(2) / 100
  );
  ...
  let seven_sediment = seven_x;
  let seven_mentions = Number(
    populated_tickers.data[6].mentions.toFixed(2) / 100
  );
  ...
  let eight_sediment = eight_x;
  let eight_mentions = Number(
    populated_tickers.data[7].mentions.toFixed(2) / 100
  );
  ...
  let nine_sediment = nine_x;
  let nine_mentions = Number(
    populated_tickers.data[8].mentions.toFixed(2) / 100
  );
  ...
  let ten_sediment = ten_x;
  let ten_mentions = Number(
    populated_tickers.data[9].mentions.toFixed(2) / 100
  );
